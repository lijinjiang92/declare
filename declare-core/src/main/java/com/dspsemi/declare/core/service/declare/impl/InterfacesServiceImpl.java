...
import com.dspsemi.declare.core.dao.declare.InterfacesMapper;
...
public class InterfacesServiceImpl extends AbstractService<Interfaces> implements
		InterfacesService {
	...
	public Interfaces add(Interfaces interfaces) {
	...
	public int delete(String id) {
		return 0;
		//return this.delete(SqlGrammar.instance(Interfaces.class).eq(R.Interfaces.id, id));
	}

	public Interfaces load(String id) {
		return this.get(id);
	}
	...
	@Override
	public DataPage<Interfaces> page(int pageNo,int pageSize) {
		//TODO
		return null;
	}
}