package com.dspsemi.declare.core.discuzApi.client;
...
import com.dspsemi.declare.core.discuzApi.util.Base64;
/**
 * ================================================
...
public abstract class PHPFunctions {
	...
	protected String base64_decode(String input){
		try {
			return new String(com.dspsemi.declare.core.discuzApi.util.Base64.decode(input.toCharArray()),"iso-8859-1");
		} catch (Exception e) {
			return e.getMessage();
		}
	}
